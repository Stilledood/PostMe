...
from .views import StoryDetailsWithSerializer,StoryCreateWithSerializer,StoryListWithSerailizer,StoryDelete,StoryActionView
...
urlpatterns = [
    ...
    path("action",StoryActionView.as_view(),name='story_action')
